...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(210.75,469.95,1,1,0,0,0,113.4,82.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// background
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.Bitmap1, null, new cjs.Matrix2D(0.361,0,0,0.361,-447.1,-632.4)).s().p("EhF2Bi0MAAAjFnMCLtAAAMAAADFng");
	this.shape.setTransform(447.075,632.375);
...
p.nominalBounds = new cjs.Rectangle(447,632,447.20000000000005,632.8);
// library properties:
lib.properties = {
